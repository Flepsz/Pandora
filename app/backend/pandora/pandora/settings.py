...
SECRET_KEY = 'django-insecure-g-nx&zm7sao+apma(t)ie)ovt)drx)thad+tbrj^-4vrz-57vp'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Pandora",

    # Copyright on the footer
    "copyright": "Pandora Ltd",
