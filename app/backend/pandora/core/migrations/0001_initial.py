# Generated by Django 4.2.5 on 2023-09-18 13:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ClientNP',
            fields=[
                ('client_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.client')),
                ('cpf', models.CharField(max_length=11, unique=True)),
                ('rg', models.CharField(max_length=9, unique=True)),
                ('idClient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='client_np', to='core.client')),
            ],
            bases=('core.client',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idClient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='client_lp', to='core.client')),
            ],
            bases=('core.client',),
        ),
    ]
